...
class CrossModalPairwiseTrain(CrossModalTrainBase):
    def __init__(self, img_dir: str, img_names: np.ndarray, txt_matrix: np.ndarray, label_matrix: np.ndarray, transform, batch_size):
        super(CrossModalPairwiseTrain, self).__init__(img_dir, img_names, txt_matrix, label_matrix, transform)
